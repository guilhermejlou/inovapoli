...
\begin{quote}\footnotesize\itshape Nota: a missão, os valores e os números de tração desta seção são informações institucionais da empresa, não relatadas literalmente pelo entrevistado.\end{quote}
