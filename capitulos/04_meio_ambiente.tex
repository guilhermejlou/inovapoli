...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[font=\small,
      tier/.style={draw, fill=gray!12, align=center, trapezium,
                   trapezium left angle=70, trapezium right angle=110,
                   trapezium stretches=true, minimum height=14mm, inner sep=2pt},
      node distance=0mm]
    \node[tier, minimum width=70mm] (tam) {\textbf{TAM} -- R\$~30--40 bi/ano};
    \node[tier, minimum width=46mm, below=2mm of tam, fill=gray!20] (sam) {\textbf{SAM} -- R\$~10--12 bi/ano};
    \node[tier, minimum width=24mm, below=2mm of sam, fill=blue!12] (som) {\textbf{SOM} -- R\$~180--500 mi/ano};
  \end{tikzpicture}
