...
Este relatório caracterizou o modelo de negócio, o ambiente competitivo e a estrutura organizacional da Capim Software, e analisou em profundidade seu processo decisório de inovação à luz de quatro frameworks da disciplina PRO3584 (detalhados no Capítulo~\ref{cap:processo-decisorio} e sintetizados nas Figuras~\ref{fig:matriz-incerteza}, \ref{fig:cadeia-valor}, \ref{fig:portfolio-bolhas} e \ref{fig:funil-dna}). O achado central, convergente nos quatro frameworks, é que a Capim aplica a mesma estrutura de governança (métrica por iniciativa e ciclo trimestral) a projetos de incerteza muito distinta, e não evidencia, na entrevista realizada, um mecanismo formal de geração e descoberta de oportunidades.

Em resposta direta à devolutiva recebida sobre a versão anterior deste trabalho, conclui-se que a Capim tem, sim, um problema de geração de ideias: falta um mecanismo sistemático que as faça emergir, independentemente da disponibilidade pontual da liderança -- não uma escassez de boas iniciativas em si. A proposta de aprimoramento apresentada no Capítulo~\ref{cap:diagnostico-proposta} (uma função de Descoberta, um \textit{learning plan} formal para iniciativas em incubação, a diferenciação explícita de critérios por tipo de processo, mecanismos formais de \textit{resourcing} e a revisão periódica do portfólio) busca corrigir essa lacuna sem descartar os elementos do sistema atual que já se mostram alinhados às boas práticas discutidas em aula.
