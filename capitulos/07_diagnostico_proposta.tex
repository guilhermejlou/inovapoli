...
\begin{figure}[h]
  ...
  \begin{tikzpicture}[
    ...
    \foreach \i/\d/\a/\b in {
      0/Geração de ideias/{Informal, percepções da liderança}/{Hub de Descoberta + polinização},
